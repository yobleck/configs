...
def log(i):
    f = open("/home/alarm/.config/qtile/qtile_log.txt", "a")
    f.write(str(i) + "\n")
    f.close()
...
class Button(configurable.Configurable):
    ...
    ("icon_path", "/home/alarm/.config/qtile/icons/pine64_orange.svg", "file path of button icon image"),
...
default_button = Button(cmd=("st", "st -e NNN"), grid_pos=(0,0))
button2 = Button(text="default button 2", cmd=("st", "st"), grid_pos=(1,0))
button3 = Button(text="default button 3",cmd=("st", "st"), grid_pos=(2,1))
